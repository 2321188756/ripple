  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center gap-4 p-8">
      ...
      <div className="relative">
        <div
          className="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary to-violet-500 flex items-center justify-center shadow-lg shadow-primary/20 text-3xl overflow-hidden"
        >
          {selectedAgent?.icon ? (
